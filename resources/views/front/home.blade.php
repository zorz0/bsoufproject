...
<section class="u-clearfix u-section-1">
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <img class="u-image u-image-contain u-image-default lazyload u-image-2" alt="" data-src="{{asset('/assets/bks')}}/images/-2.png">
    </div>
</section>

<section class="u-clearfix u-section-1">
    <img class="u-image u-image-contain u-image-default lazyload u-image-3" alt="" data-src="{{asset('/assets/bks')}}/images/dots.png">
    ...
    <div class="col-md-12 col-sx-4 store">
        ...
        <div class="col-md-3 stor-item">
            <img class="u-image u-image-contain u-image-default lazyload u-image-3" alt=""
                data-src="{{asset('/assets/bks')}}/images/Artboard 52.png">
        </div>
        <div class="col-md-3 stor-item">
            <img class="u-image u-image-contain u-image-default lazyload u-image-3" alt=""
                data-src="{{asset('/assets/bks')}}/images/Artboard 53.png">
        </div>
        <div class="col-md-3 stor-item">
            <img class="u-image u-image-contain u-image-default lazyload u-image-3" alt=""
                data-src="{{asset('/assets/bks')}}/images/Artboard 54.png">
        </div>
    </div>
</section>
...
<section class="u-clearfix u-section-1">
    <div>
        <img class="u-image u-image-contain u-image-default lazyload u-image-2" alt="" data-src="{{asset('/assets/bks')}}/images/news.png">
    </div>
    <div class="col-md-12 col-sx-4">
        <div class="ct-blog col-sm-6 col-md-4">
            <div class="fauxcrop">
                <a href="#"><img alt="News Entry" src="{{asset('/assets/bks')}}/images/news1.png"></a>
            </div>
        </div>
        <div class="ct-blog col-sm-6 col-md-4">
            <div class="fauxcrop">
